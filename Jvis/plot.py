...
try:
    ...
    warn(
        """The Jvis.plot package requires extra plotting libraries to be installed.
    You can install these via pip using

    pip install Jvis-learn[plot]
    ...
    raise ImportError(
        "Jvis.plot requires pandas matplotlib datashader bokeh holoviews and colorcet to be "
        "installed"
    ) from None
...
from Jvis.nndescent import initialise_search, initialized_nnd_search
from Jvis.utils import deheap_sort, submatrix
...
def points(
    ...
    pass in the trained/fit Jvis model to get results. This plot
